        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    ...
                    <img alt="Logo" src="{{ asset('dist/assets/media/logos/logo.png') }}" class="h-40px logo" />
                    <div class="text-center mt-2">
                        <p class="text-muted" style="font-size: 18px; margin-bottom: 8px;">SANGGITA</p>
                        <p class="text-muted" style="font-size: 7px; margin-top: -8px;">Sistem Realisasai Anggaran
                            Kegiatan</p>
                    </div>
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-6">
                                    ...
                                    <div
                                        class="overlay overflow-hidden position-relative border border-4 border-gray-200 rounded">
                                        <div class="overlay-wrapper">
                                            <img src="{{ asset('dist/assets/media/demos/demo10.png') }}"
