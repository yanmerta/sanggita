...
<html lang="en">
	<!--begin::Head-->
	<head><base href="">
		<title>Dashboard || Frontpage</title>
		<meta charset="utf-8" />
	...
	<body id="kt_body" data-bs-spy="scroll" data-bs-target="#kt_landing_menu" data-bs-offset="200" class="bg-white position-relative">
							...
							<div class="d-flex align-items-center justify-content-between">
								...
								<div class="d-flex align-items-center flex-equal">
									...
									<a href="../../demo1/dist/landing.html">
										<img alt="Logo" src="{{ asset('dist/assets/media/logos/logo-landing.svg') }}" class="logo-default h-25px h-lg-30px" />
										<img alt="Logo" src="{{ asset('dist/assets/media/logos/logo-landing-dark.svg') }}" class="logo-sticky h-20px h-lg-25px" />
									</a>
									<!--end::Logo image-->
								</div>
								<!--end::Logo-->
		...
		<script src="{{ asset('dist/assets/plugins/custom/fslightbox/fslightbox.bundle.js') }}"></script>
		<script src="{{ asset('dist/assets/plugins/custom/typedjs/typedjs.bundle.js') }}"></script>
		<!--end::Page Vendors Javascript-->
		<!--begin::Page Custom Javascript(used by this page)-->
		<script src="{{ asset('dist/assets/js/custom/landing.js') }}"></script>
		<script src="{{ asset('dist/assets/js/custom/pages/pricing/general.js') }}"></script>
